...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_42018 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_42018(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_42019 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_42019(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_42021 = (function (reader,ch){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_42021(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_42022 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_42022(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_42023 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_42023(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_42024 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_42024(reader);
}
});
...
var G__42282 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null, );
var G__42283 = s.append(c);
c = G__42282;
s = G__42283;
continue;
}
