...
var i_35720 = (self__.level + (1));
while(true){
if((i_35720 <= (new_level + (1)))){
(update[i_35720] = self__.header);

var G__35721 = (i_35720 + (1));
i_35720 = G__35721;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_35723 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_35723[i]));
} else {
x__$2.forward.push((((i < links_35723.length))?(links_35723[i]):null));
}

if((i < links_35723.length)){
(links_35723[i] = x__$2);
} else {
links_35723.push(x__$2);
}
...
var i_35726 = (0);
while(true){
if((i_35726 <= self__.level)){
var links_35727 = (update[i_35726]).forward;
if((x__$1 === (((i_35726 < links_35727.length))?(links_35727[i_35726]):null))){
(links_35727[i_35726] = (x__$1.forward[i_35726]));

var G__35731 = (i_35726 + (1));
i_35726 = G__35731;
continue;
} else {
var G__35732 = (i_35726 + (1));
i_35726 = G__35732;
continue;
}
} else {
...
var G__35734 = nx;
var G__35735 = (level__$1 - (1));
x = G__35734;
level__$1 = G__35735;
continue;
} else {
var G__35736 = x;
var G__35737 = (level__$1 - (1));
x = G__35736;
level__$1 = G__35737;
continue;
}
